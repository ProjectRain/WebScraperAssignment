...
public class CreateFeed extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //from parameter map.
            out.println("Path:<br>");
            out.printf("<input type=\"text\" name=\"path\" value=\"\"><br>",FeedLogic.PATH); 
            out.println("Type:<br>");
            out.printf("<input type=\"text\" name=\"type\" value=\"\"><br>",FeedLogic.TYPE);
            out.println("Name:<br>");
            out.printf("<input type=\"text\" name=\"name\" value=\"\"><br>",FeedLogic.NAME);
            out.println("Host ID:<br>");
            out.printf("<input type=\"number\" name=\"hostid\" value=\"\"><br>",FeedLogic.HOST_ID);
