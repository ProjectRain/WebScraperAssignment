...
public class CreateAccount extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //from parameter map.
            out.println("Name:<br>");
            out.printf("<input type=\"text\" name=\"displayName\" value=\"\"><br>",AccountLogic.DISPLAY_NAME); 
            out.println("User:<br>");
            out.printf("<input type=\"text\" name=\"user\" value=\"\"><br>",AccountLogic.USER);
            out.println("Password:<br>");
            out.printf("<input type=\"text\" name=\"password\" value=\"\"><br>",AccountLogic.PASSWORD);
